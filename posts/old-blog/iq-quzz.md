...
<div class="picture in"><img style="height:450px; width:auto;"  src="https://0a.io/img/old-blog/q26.png"></div>
<div>
...
<div class="picture in" ><img style="height:450px; width:auto;" src="https://0a.io/img/old-blog/q37.png"></div>
<div>
<span class="hx"><a>show hint</a></span>
<span class="s"><a>show solution<br><br></a></span>
...
<div class="picture in" ><img style="height:450px; width:auto;" src="https://0a.io/img/old-blog/q36.png"></div>
<div>
<span class="hx"><a>show hint</a></span>
<span class="s"><a>show solution<br><br></a></span>
...
<div class="picture in" ><img style="height:450px; width:auto;" src="https://0a.io/img/old-blog/q39.png"></div>
<div>
<span class="hx"><a>show hint</a></span>
<span class="s"><a>show solution<br><br></a></span>
...
<br>
<ul>
<li>If you are taking too long to devise a principles-based theory that works, go back to step 1, this time study other correlated pictures, or consider the possibility that the pattern can be described by a transformations-based theory.
</ul>
</ol>
<br>
...
<div class="picture">
<img src="https://0a.io/img/old-blog/dick.jpg">
</div>
...
var s1 = $(".solution");
var s1l = s1.length;
function archy(solution,hint,button1,button2,t){
    this.s1 = solution;
    this.h1 = hint;
    this.s0 = button1;
    this.h0 = button2;
...
archy.prototype.wilhes2 = function(){
this.s0.fadeOut(300);
        if(this.x){
        this.s1.fadeIn(400);
        }else{
        this.h0.fadeOut(300);
        this.s1.add(this.h1).fadeIn(400);
        }
var a =0;
while(a<s1l){
archys[a].tt = archys[a].t.offset().top+350;
a++;
}
}
archy.prototype.wilhes = function(){
    this.s0.on("click", null, null, $.proxy(function(){
    this.wilhes2();
    },this),1);
    this.h0.on("click", null, null, $.proxy(function(){
        this.x = true;
        this.h0.fadeOut(300);
        this.h1.fadeIn(400);
    this.tt = this.t.offset().top+300;
    },this),1);
}
var a = 0;
var h1 = $(".hint");
...
var t = $(".titlez");
while(a<s1l){
archys[a] = new archy(s1.eq(a),h1.eq(a),s0.eq(a),h0.eq(a),t.eq(a));
archys[a].wilhes();
a++;
}
h0.css("margin-right","20px");
$(window).load(function() {
for(a=0;a<s1l;a++){
 (function(b) {
archys[b].tt = archys[b].t.offset().top+350;
$(window).on("scroll."+b, function(){
if($(this).scrollTop()>(archys[b].tt-$(this).height())){
archys[b].wilhes2();
$(this).off("scroll."+b);
}
});
